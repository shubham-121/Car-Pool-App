...
//             <p className=" h-10 text-[45px]  inline bg-black  text-white">
//               Earn. Connect.{" "}
//             </p>
//             <br></br>
//             <p className="h-10 text-[45px] bg-black inline text-yellow-300    text-white">
//               Contribute To Saving
//             </p>{" "}
//             <br></br>
//             <p className="h-10 text-[45px]  inline  bg-black  text-white mt-2">
//               The Environment
//             </p>
//             <p className="border-custom font-bold italic inline-block text-[20px]  text-white mt-2">
//               Partner with us to drive your own livelihood and more.Partner with
//               us to drive your own livelihood and more.
//             </p>
//             <div className="flex justify-evenly items-center flex-row mt-2 mb-2  ">
//               <button className="border-custom font-semibold text-xl hover:scale-105  text-white bg-gray-900 px-6 py-3   rounded-2xl  gap-4">
//                 Post A Ride
//               </button>
//               <button className="border-custom font-semibold text-xl hover:scale-105  text-white bg-gray-900 px-6 py-3   rounded-2xl gap-4">
//                 Look For Ride
